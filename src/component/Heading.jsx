...
const Heading = ({first ,second, paragraph,className}) => {
  return (
    <div className=" w-full flex flex-col justify-center items-center my-16 max-lg:my-14   " >
      <div className="my-8" >
        <span className="text-[#5D50C6] font-bold text-5xl max-sm:text-4xl   " >{first} </span>
